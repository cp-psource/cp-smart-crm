...
<h1 style="text-align:center">WP Smart CRM & INVOICES<?php if(! isset($_GET['p'])){ ?><?php } ?></h1>
    ...
    echo '<small style="text-align:center;top:30px;position:relative">Developed by SoftradeWEB snc <a href="https://softrade.it">https://softrade.it</a> [WP italian coders]. ' . __('Like this Plugin? A good Review is very much appreciated!','cpsmartcrm').'<a href="https://wordpress.org/support/plugin/cp-smart-crm/reviews/?filter=5" target="_blank"><span class="dashicons dashicons-star-filled" style="font-size:1em;margin-right:-6px;margin-top:4px"></span><span class="dashicons dashicons-star-filled" style="font-size:1em;margin-right:-6px;margin-top:4px"></span><span class="dashicons dashicons-star-filled" style="font-size:1em;margin-right:-6px;margin-top:4px"></span><span class="dashicons dashicons-star-filled" style="font-size:1em;margin-right:-6px;margin-top:4px"></span><span class="dashicons dashicons-star-filled" style="font-size:1em;margin-right:-6px;margin-top:4px"></span></a>  </small>';
	?>
