...
function WPsCRM_register_CRM_plugins() {
    ...
    $config = array(
        ...
        'notice_can_activate_required' => _n_noop( 'The following required plugin for CP Smart CRM is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.' ), // %1$s = plugin name(s).
